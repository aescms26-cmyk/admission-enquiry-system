...
if (isPlaceholder) {
  console.error('CRITICAL: Supabase credentials missing or invalid in server. Please set VITE_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY in the Secrets panel.');
}
